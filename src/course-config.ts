...
export const courseMeta = slopCourseMetaSchema.parse({
  code: "SLOP8171",
  title: "Chain of Custody: Content Forensics for the Synthetic Age",
  session: "Semester 1",
  year: 2027,
  level: 8,
  ...
  endDate: "2027-05-28",
  description:
    "A graduate methods course in detecting, verifying and tracing " +
    "AI-generated text, images, video and audio. Every claim online is " +
    "treated as a case that deserves a chain of custody, not a hunch.",
  tags: ["media forensics", "verification", "AI literacy"],
